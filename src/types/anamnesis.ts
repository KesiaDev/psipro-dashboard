...
export const DEFAULT_ANAMNESIS_ITEMS: Omit<AnamnesisItem, "value">[] = [
  ...
  { key: "doencas_previas", label: "Doenças prévias (cirurgias, doenças crônicas)" },
  { key: "uso_medicacoes", label: "Medicações em uso" },
  ...
  { key: "consumo_alcool", label: "Consumo de álcool" },
  { key: "exames_realizados", label: "Exames já realizados" },
  { key: "resultados_exames", label: "Resultados de exames" },
